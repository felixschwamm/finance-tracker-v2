...
>
    ...
    >
        ...
        >
            <span class="mb-3" style="text-align: center; font-size: 18px"
                >Betrag</span
            >
            <FullWidthInput fontSize={60} bind:this={amountInput}
            ></FullWidthInput>
        </div>
        <div class="d-flex justify-content-between w-100 p-3">
            <button
                on:click={() => (opened = !opened)}
                class="btn text-primary rounded">Abbrechen</button
            >
            <button
    ...
    >
        ...
        >
            ...
            >
            <FullWidthInput
                on:changeText={(val) => (nameInputValue = val.detail)}
                type="text"
    ...
    >
        ...
        >
            <span class="mb-3" style="text-align: center; font-size: 18px"
                >Kategorie</span
            >
            <CategorySelection selectedCategory={ExpenseCategory.SONSTIGES}
            ></CategorySelection>
        </div>
        <div class="d-flex justify-content-between w-100 p-3">
            <button
                ...
                class="btn text-primary rounded">Zurück</button
            >
            <button class="btn btn-primary rounded bg-primary">Fertig</button>
        </div>
    </div>
</div>
